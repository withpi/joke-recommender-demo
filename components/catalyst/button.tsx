...
const styles = {
  ...
  colors: {
    ...
    violet: [
      'text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:var(--color-deep-purple)] [--btn-border:var(--color-deep-purple)]/90',
      '[--btn-icon:var(--color-violet-300)] data-active:[--btn-icon:var(--color-violet-200)] data-hover:[--btn-icon:var(--color-violet-200)]',
    ],
    purple: [
      'text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:var(--color-purple-700)] [--btn-border:var(--color-purple-800)]/90',
...
export type ButtonProps = (
  | { color?: keyof typeof styles.colors; outline?: never; plain?: boolean }
