...
// Infer the prop types from the Button component
type ButtonProps = React.ComponentPropsWithoutRef<typeof Button>;

type DropdownButtonProps<T extends React.ElementType = typeof Button> = Omit<
  Headless.MenuButtonProps<T>,
  'as'
> & {
  as?: T;
} & (T extends typeof Button ? ButtonProps : React.ComponentPropsWithoutRef<T>);
...
export function DropdownButton<T extends React.ElementType = typeof Button>({
  ...
  return <Headless.MenuButton as={Component as any} {...(props as any)} />;
}
